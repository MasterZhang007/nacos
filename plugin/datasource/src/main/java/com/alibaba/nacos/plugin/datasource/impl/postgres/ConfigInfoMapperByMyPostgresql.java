 ...
 * @date 2024/11/29 14:12
 */
public class ConfigInfoMapperByMyPostgresql extends AbstractMapperByPostgresql implements ConfigInfoMapper {
    ...
    public MapperResult findConfigInfoLike4PageFetchRows(MapperContext context) {
        ...
        where.offsetLimit(context.getStartRow(), context.getPageSize());
        return where.build();
    }
    ...
    public MapperResult findAllConfigInfoFetchRows(MapperContext context) {
        ...
        return new MapperResult(sql,
                CollectionUtils.list(context.getWhereParameter(FieldConstant.TENANT_ID), context.getStartRow(), context.getPageSize()));
    }
